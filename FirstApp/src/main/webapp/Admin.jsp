...
<body>
		...
		<table class="taskTable">
			...
			<c:forEach var="task" items="${listTask}">
				<tr>
					...
					<td><a href="deleteTask?id=<c:out value='${task.id}' />">Delete</a>"        "<a href="TaskShowEditForm?id=<c:out value='${task.id}' />">edit</a>    </td>
			...
			<tr>
				<form action="getTasksByEmployee">
					<div>
	...
	<section class="task forms">
		...
		<form action="addTaskToEmployee" method="post">
